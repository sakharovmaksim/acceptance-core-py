...
class InputField(Block):
    def input_with_check(self, string_to_input: str):
        ...
        driver_actions.input_in_field(self.me.__str__(), string_to_input, need_check_for_correctly_input=True)

    def input(self, string_to_input: str):
        driver_actions.input_in_field(self.me.__str__(), string_to_input, need_check_for_correctly_input=False)
