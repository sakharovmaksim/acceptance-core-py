...
class ScreenshotActions:
    ...
    def capture_full_page_screenshot(self, screenshot_name_postfix: str = "") -> str:
        """Return uploaded screenshot URL in s3 storage"""
        screenshot_url = ""
        ...
        if is_successfully_saved:
            uploaded_screenshot_url = S3Client().publish_screenshot(
                screenshot_local_storage_data
            )
    ...
    def create_screenshot_local_storage_data(
        ...
        # Example: /some-project/acceptance-selenium-tests-my/output/screenshots/test_screenshots-2020-01-22-20-03-53/
        ...
        # Example:
        # /some-project/acceptance-selenium-tests-my/output/screenshots/test_screenshots-2020-01-22-20-03-53/test_correctly_opening_pages_py_test_screenshots_20_03_54_889506.png
